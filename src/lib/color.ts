...
export const hslToHex = (hsl: HSL): string => { const { r, g, b } = hslToRgb(hsl); return rgbToHex(r, g, b); };
...
export const hsvToHex = (hsv: HSV): string => { const { r, g, b } = hsvToRgb(hsv); return rgbToHex(r, g, b); };
